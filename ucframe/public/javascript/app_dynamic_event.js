...
function event_keyup(){
  ...
  // ctrl
  var event1 = document.getElementById('EventFlow-input-1').value;
  var event2 = document.getElementById('EventFlow-input-2').value;
  var event3 = document.getElementById('EventFlow-input-3').value;
  var event4 = document.getElementById('EventFlow-input-4').value;
  var event5 = document.getElementById('EventFlow-input-5').value;
  var event6 = document.getElementById('EventFlow-input-6').value;
  var event7 = document.getElementById('EventFlow-input-7').value;
  var event8 = document.getElementById('EventFlow-input-8').value;
  var event9 = document.getElementById('EventFlow-input-9').value;
  
  //console.log('event1:'+event1);
    
  update_by_string(event1);
  update_by_string(event2);
  update_by_string(event3);
  update_by_string(event4);
  update_by_string(event5);
  update_by_string(event6);
  update_by_string(event7);
  update_by_string(event8);
  update_by_string(event9);
