...
outline = function(){
    ...
    var bound_margin = [20, 20, 20, 20];
    
    var lineData = [ { "x":-margin.left, "y":-margin.top}, {"x":-margin.left, "y":height+margin.bottom},
                     { "x":width+margin.right, "y":height+margin.bottom}, {"x":width+margin.right, "y":-margin.top},
                     { "x":-margin.left, "y":-margin.top}];
    
    var seplineData = [ { "x":-margin.left+width*0.3, "y":-margin.top}, { "x":-margin.left+width*0.75, "y":-margin.top},
                        { "x":-margin.left+width*0.75, "y":height+margin.bottom}, { "x":-margin.left+width*0.3, "y":height+margin.bottom},
                        { "x":-margin.left+width*0.3, "y":-margin.top}];
    ...
    var lineGraph = svg.append("path")
                       .attr("d", lineFunction(seplineData))
                       .attr("stroke", "lightgray")
                       .attr("stroke-width", 3)
                       .attr("fill", "none")
                       .attr("opacity", 0.7);
