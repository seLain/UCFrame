...
function event_keyup(){
  ...
  // ctrl
  var pre1 = document.getElementById('PostCondition-Condition-input-1').value;
  var pre2 = document.getElementById('PostCondition-Condition-input-2').value;
  var pre3 = document.getElementById('PostCondition-Condition-input-3').value;
